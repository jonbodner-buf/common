...
const file_person_v1_person_proto_rawDesc = "" +
	...
	"\x03age\x18\x02 \x01(\x05R\x03ageB\x99\x01\n" +
	"\rcom.person.v1B\vPersonProtoP\x01Z6github.com/jonbodner-buf/common/gen/person/v1;personv1\xa2\x02\x03PXX\xaa\x02\tPerson.V1\xca\x02\tPerson\\V1\xe2\x02\x15Person\\V1\\GPBMetadata\xea\x02\n" +
